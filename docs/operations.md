...
`rubylens` is centered on static analysis work in Ruby. The technical target is: Crawl static-site links and report broken internal references.
...
The score is deterministic. The current threshold is 180. Risk has a penalty of 4, latency has a penalty of 2, and weight contributes a bonus of 6.
