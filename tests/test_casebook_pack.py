"""Regression checks for the rubylens casebook."""
...
from casebook.harness import assert_expected, rubylens_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(rubylens_summary(), assert_expected())
